...
use App\Filament\Resources\Kegiatans\Tables\KegiatanTable;
...
class KegiatanResource extends Resource
{
    ...
    // ✅ Sesuai dengan tipe di parent class
    protected static \UnitEnum|string|null $navigationGroup = 'SMP Mentari';

    // ✅ Perbaikan tipe: BackedEnum|string|null
    ...
    {
        return KegiatanTable::table($table);
    }
